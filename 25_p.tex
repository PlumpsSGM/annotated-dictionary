...
% pamrelvul
\hi
\HT{pamrelvul}{\B{pam\cp{rel}vul}} \I{[pam."REl.vul]} \emph{or} \I{[.vUl]} \emph{n.} pen, pencil, writing utensil (\emph{often shortened to} \ding{43}~\HL{relvul}{\B{rel\-vul}}).
...
% pay+
\hi
\HT{pay+}{\B{pay}}\texttt{+} \I{[paj.]} \emph{inter. pref. on nouns to mean} which (of them)? (\emph{plural})
...
% pay
\hi
\HT{pay}{\B{pay}} \I{[paj]} \emph{n.} water, liquid. 
...
% pemsu
\hi
\HT{pemsu}{\B{pem\cp{su}}} \I{[pEm."{}su]} \emph{inter.} who? what two people?~\LINK{https://naviteri.org/2011/07/number-in-na\%E2\%80\%99vi/}{b} (\emph{alternate form:} \ding{43}~\HL{pemsu}{\B{me\-su\-pe}})
(\ding{43}~\HL{pem+}{\B{pem}}\texttt{+}, \HL{tute1}{\B{tu\-te}}) 
	
% pemstan
\hi
\HT{pemstan}{\B{pem\cp{stan}}} \I{[pEm."{}stan]} \emph{inter.} who? what two men?~\LINK{https://naviteri.org/2011/07/number-in-na\%E2\%80\%99vi/}{b} (\emph{alternate form:} \ding{43}~\HL{pemstan}{\B{me\-stam\-pe}})
(\ding{43}~\HL{pem+}{\B{pem}}\texttt{+}, \HL{tutan}{\B{tu\-tan}}) 	
	
% pemste
\hi
\HT{pemste}{\B{pem\cp{ste}}} \I{[pEm."{}stE]} \emph{inter.} who? what two women?~\LINK{https://naviteri.org/2011/07/number-in-na\%E2\%80\%99vi/}{b} (\emph{alternate form:} \ding{43}~\HL{pemste}{\B{me\-ste\-pe}})
...
% pepsu
\hi
\HT{pepsu}{\B{pep\cp{su}}} \I{[pEp\textcorner."{}su]} \emph{inter.} who? what three people? \emph{alternate form:} \ding{43}~\HL{pepsu}{\B{pxe\-su\-pe}}
...
% pepstan
\hi
\HT{pepstan}{\B{pep\cp{stan}}} \I{[pEp\textcorner."{}stan]} \emph{inter.} who? what three men? \emph{alternate form:} \ding{43}~\HL{pepstan}{\B{pxe\-stam\-pe}}
(\ding{43}~\HL{pep+}{\B{pep}}\texttt{+}, \HL{tutan}{\B{tu\-tan}}) 	
	
% pepste
\hi
\HT{pepste}{\B{pep\cp{ste}}} \I{[pEp\textcorner."{}stE]} \emph{inter.} who? what three women? \emph{alternate form:} \ding{43}~\HL{pepste}{\B{pxe\-ste\-pe}}
(\ding{43}~\HL{pep+}{\B{pep}}\texttt{+}, \HL{tute2}{\B{tu\-té}}) 

% peseng
\hi
\HT{peseng}{\B{pe\cp{seng}}} \I{[pE."{}sEN]} \emph{or} \B{pe\cp{se}nge} \I{[pE."{}sE.NE]} \emph{inter.} where? what place? (\emph{alternative form:} \ding{43}~\HL{tseng}{\B{tseng\-pe}})
\B{Tok pe\-se\-nget pam\-rel\-ìl?} Where is the text?~\LINK{https://naviteri.org/2014/06/teri-tsaliu-alu-nifkeytongay-about-nifkeytongay/}{b}
...
% peslosnep
\hi
\HT{peslosnep}{\B{peslo\cp{snep}}} \I{[pE.slo."{}snEp\textcorner]} \emph{inter.} what width? how wide? (\emph{alternate form:} \ding{43}~\HL{slosnep}{\B{slo\-snep\-pe}})
(\ding{43}~\HL{pe+}{\B{pe}}\texttt{+}, \HL{slosnep}{\B{slo\-snep}}) 

% pesomwew
\hi
\HT{pesomwew}{\B{pesom\cp{wew}}} \I{[pE.som."wEw]} \emph{inter.} what temperature? (\emph{alternate form:} \ding{43}~\HL{somwew}{\B{som\-wew\-pe}})
