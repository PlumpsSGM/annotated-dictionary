...
(\emph{c. proverb}) \B{Kem\-ìri a nga\-ru prr\-te' ke lu, tsa\-kem rä\-'ä si\-vi ay\-la\-he\-ru.} As for any action that you don't like, don't act that way to others.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Good\_Morning\_America}{wiki}
...
\B{'Uo a fpi rey\-'eng Ey\-wa\-'e\-veng\-mì, 'Rr\-ta\-mì tsran\-ten nì\-txan aw\-nga\-ru nì\-wotx.} Something that matters a lot to all of us for the sake of The Balance of Life on both Pandora and Earth.~\LINK{https://wiki.learnnavi.org/index.php/Corpus\#Earth\_Day\_Message}{ln} 
...
\B{Re\-rol ay\-oe ay\-nga\-ne}, We are singing your way.~\LINK{http://wiki.learnnavi.org/index.php/Hunting\_Song}{wiki}
