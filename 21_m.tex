...
% mangkuan
\hi 
\HT{mangkuan}{\B{\cp{Mang}kuan}} \I{["maN.ku.an]} \emph{n., clan name} the Ash People.~\LINK{https://naviteri.org/2025/11/kaltxi-nimun-hello-again/}{b}
...
\B{Maw hì\-krr ay\-oe tì\-yä\-txaw.} We'll be right back after this break.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Good\_Morning\_America}{wiki} 
...
(\emph{a. idiom}) \B{Mip\-a zì\-sìt le\-fpom nga\-ru!} Happy New Year to you!~\LINK{https://wiki.learnnavi.org/Canon\#Extracts\_from\_various\_emails}{b}
...
\B{Ay\-lì\-'u na ay\-skxe mì te'\-lan.} The words (are) like stones in (my) heart.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Behind\_the\_Scenes}{wiki}
