...
% emza'u
\hi
\HT{emza'u}{\B{em\cp{za}'u}} \I{[Em."z$\cdot$a.P$\cdot$u]} \emph{vtr., inf.}\on{23} pass (a test). \B{Sì\-fme\-tok\-it em\-zo\-la\-'u ohel.} I have passed the tests.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Behind\_the\_Scenes}{wiki} 
...
\B{Eo ay\-oeng lu txan\-a tì\-kawng.} A great evil is upon us.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Behind\_the\_Scenes}{wiki} 
