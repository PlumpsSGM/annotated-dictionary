...
\B{Hem nge\-yä zen\-ke fko\-ru li\-vu, tsay\-hem a nga\-ru prr\-te' ke lu.} Your actions must not be to others (as) those actions that you don't like.~\LINK{http://wiki.learnnavi.org/index.php?title=Corpus\#Good\_Morning\_America}{wiki}
...
\B{Sì ay\-zì\-sìt\-ä ka\-to | Sì ekong te'\-lan\-ä.} And the rhyhtm of the years | And the beats of the hearts.~\LINK{http://wiki.learnnavi.org/index.php/Weaving\_Song}{wiki}
